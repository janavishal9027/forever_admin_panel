      ...
      <div>
        ...
        <div className='flex gap-2'>
          <label htmlFor='image1'>
            <div className='w-20 h-20 bg-gray-200 flex items-center justify-center cursor-pointer border-2 border-dashed'>
              {image1 ? (
                <img className='w-full h-full object-cover' src={URL.createObjectURL(image1)} alt='' />
              ) : (
                <svg className='w-6' viewBox="0 0 24 24" fill="none" stroke="gray" strokeWidth="2">
